...
namespace HolidayDatabase
{
    ...
    {
        private Font printFont = new Font("Consolas", 10.0f);
        private Font printFontBold = new Font("Consolas", 14.0f, FontStyle.Bold);
        ...
        private string GetHeaderText(int page)
        {
            ...
            header += $"Date: {now.Day:d2}/{now.Month:d2}/{now.Year:d4}\n\n".PadLeft(40);
